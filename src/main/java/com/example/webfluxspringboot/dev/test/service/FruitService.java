package com.example.webfluxspringboot.dev.test.service;

import com.example.webfluxspringboot.dev.test.responseDto.FruitInfoResponseDto;
...
public class FruitService {
    ...
    public Flux<FruitInfoResponseDto> fruits() {
        return basketFlux.concatMap(basket -> {
            ...
            return Flux.zip(distinctFruits, countFruitsMono, (distinct, count) -> new FruitInfoResponseDto(distinct, count));
        });
    }
